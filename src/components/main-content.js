    ...
    <div className="row">
      <div className="col-xs-12 col-sm-5 mb-3">
        <section className="mb-3">
          ...
          <p>
            We believe that cakes are not just a sweet but an art in itself. The
            true quality of a cake comes from its creative design handmade with
            the best of ingredients and a little bit of love!
          </p>
