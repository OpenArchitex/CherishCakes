                ...
                <div className="row">
                    <div className="mx-auto">
                        <ListGroup horizontal>
                            ...
                            <ListGroup.Item className="border-0"><FontAwesomeIcon icon={['fab', 'facebook']} size="2x"/></ListGroup.Item>
                            <ListGroup.Item className="border-0"><FontAwesomeIcon icon={['fab', 'instagram']} size="2x"/></ListGroup.Item>
                        </ListGroup>
                    </div>
                </div>
                <p>
