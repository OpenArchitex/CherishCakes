      ...
      <div className="col-xs-12 col-sm-12">
        ...
        <ul className="mt-3">
          <li>
            ...
            <p>
              Price is dependent upon the type of cake, size, design and
              fillings etc. <a href="#contact-us">Please contact me</a> to get a
              quote.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              Yes, a deposit of 50% of the price is required for the order to
              proceed.
            </p>
          </li>
          <li>
