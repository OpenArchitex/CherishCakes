...
const Testimonial = () => (
    <Container fluid className="mt-5 mb-5">
        ...
        <Carousel className="testimonialCarousel" controls={false}>
            <Carousel.Item>
                <div align="center">
                    <img className="d-block w-15"
                ...
                <Carousel.Caption>
                    <p>Thank you soo much. The cake was soo good and it was the best of all!</p>
            ...
            <Carousel.Item>
                <div align="center">
                    <img className="d-block w-15"
                         ...
                         alt="avatar2"/></div>
                <Carousel.Caption>
                    <p>Priyanga... just want to say thank you very much for the gorgeous cake for my daughter!!! Everyone
                        loved it and the cake was so delicious! Going to pass your name along to my friends if you don't
                        mind! <span role="img" aria-label="emoji">😃</span></p>
            ...
            <Carousel.Item>
                <div align="center">
                    <img className="d-block w-15"
                         ...
                         alt="avatar3"/></div>
                <Carousel.Caption>
                    <p>Thank you for the beautiful cake Priyanga. It was delicious! <span role="img" aria-label="emoji">😃</span></p>
